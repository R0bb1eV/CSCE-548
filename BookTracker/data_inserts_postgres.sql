-- Sample data for PostgreSQL (Supabase)

TRUNCATE TABLE activity, book, "user", author RESTART IDENTITY CASCADE;
...
-- =================== BOOKS (50+) ===================
INSERT INTO book (title, page_count, genre, publishing_house, year_of_release, isbn, author_id) VALUES
...
('Les Miserables', 1463, 'Historical', 'A. Lacroix', 1862, '9780451419439', 11),
